...
# disease effect: ALS vs. Control in Astro
## read in peakSets with sampleSheet

sampleSheet <- tibble(
  SampleID = paste0(subject_id, "-Astro"),
  Tissue = "MCX",
  ...
  Peaks = "snATAC_Astro_MCX_ALSandControl_merged_peaks.bed",
  PeakCaller = "bed",
  PeakFormat = "bed",
  ScoreCol = 5
)
...
pdf(file = "DiffBind_disease_ALS_vs_Control_in_Astro_raw_cor_matrix_in_snATAC_peaks.pdf")
plot(dba)
dev.off()
...
pdf(file = "DiffBind_disease_ALS_vs_Control_in_Astro_consensus_peaks_across_samples_in_snATAC_peaks.pdf")
...
pdf(file = "DiffBind_disease_ALS_vs_Control_in_Astro_consensus_peaks_by_group_in_snATAC_peaks.pdf")
...
pdf(file = "DiffBind_disease_ALS_vs_Control_in_Astro_consensus_peaks_cor_matrix_in_snATAC_peaks.pdf")
plot(dba)
dev.off()
...
save(dba, file = "diffBind_H3K27ac_ALS_vs_Control_in_Astro_addCovSex_dba_in_snATAC_peaks.rda")

pdf(file = "DiffBind_disease_ALS_vs_Control_in_Astro_addCovSex_results_in_snATAC_peaks.pdf", onefile = TRUE)
...
write_tsv(dba_edgeR_df, "diffBind_H3K27ac_ALS_vs_Control_in_Astro_addCovSex_sexTerm_res_edgeR_in_snATAC_peaks.txt")
write_tsv(dba_deseq2_df, "diffBind_H3K27ac_ALS_vs_Control_in_Astro_addCovSex_sexTerm_res_DEseq2_in_snATAC_peaks.txt")
write_tsv(dba_edgeR_df2, "diffBind_H3K27ac_ALS_vs_Control_in_Astro_addCovSex_diseaseTerm_res_edgeR_in_snATAC_peaks.txt")
write_tsv(dba_deseq2_df2, "diffBind_H3K27ac_ALS_vs_Control_in_Astro_addCovSex_diseaseTerm_res_DEseq2_in_snATAC_peaks.txt")
write_tsv(dba.show(dba) %>% as_tibble(), "diffBind_H3K27ac_ALS_vs_Control_in_Astro_newConsensus_FRiP_in_snATAC_peaks.txt")
