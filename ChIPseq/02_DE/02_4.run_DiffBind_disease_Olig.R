...
pdf(file = "DiffBind_disease_ALS_vs_Control_in_Olig_raw_cor_matrix.pdf")
plot(dba)
dev.off()
...
pdf(file = "DiffBind_disease_ALS_vs_Control_in_Olig_consensus_peaks_across_samples.pdf")
...
pdf(file = "DiffBind_disease_ALS_vs_Control_in_Olig_consensus_peaks_by_group.pdf")
...
pdf(file = "DiffBind_disease_ALS_vs_Control_in_Olig_consensus_peaks_cor_matrix.pdf")
plot(dba)
dev.off()
...
save(dba, file = "diffBind_H3K27ac_ALS_vs_Control_in_Olig_addCovSex_dba.rda")

pdf(file = "DiffBind_disease_ALS_vs_Control_in_Olig_addCovSex_results.pdf", onefile = TRUE)
...
write_tsv(dba_edgeR_df, "diffBind_H3K27ac_ALS_vs_Control_in_Olig_addCovSex_sexTerm_res_edgeR.txt")
write_tsv(dba_deseq2_df, "diffBind_H3K27ac_ALS_vs_Control_in_Olig_addCovSex_sexTerm_res_DEseq2.txt")
write_tsv(dba_edgeR_df2, "diffBind_H3K27ac_ALS_vs_Control_in_Olig_addCovSex_diseaseTerm_res_edgeR.txt")
write_tsv(dba_deseq2_df2, "diffBind_H3K27ac_ALS_vs_Control_in_Olig_addCovSex_diseaseTerm_res_DEseq2.txt")
write_tsv(dba.show(dba) %>% as_tibble(), "diffBind_H3K27ac_ALS_vs_Control_in_Olig_newConsensus_FRiP.txt")
