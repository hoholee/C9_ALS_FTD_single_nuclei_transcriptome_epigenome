...
# selected_genes <- c("HSP90AA1", "HSP90AB1", "CLU", "HSPB1", "KCND3", "RAP1GAP",
# 		    "RORB", "SYT17", "PAMR1", "LRRTM4", "CHRM3", "SLC25A4", "NDUFA4")
# selected_genes <- c("HSP90AA1", "CLU",  "KCND3", "RAP1GAP", "NDUFA4", "ATP2B4", "TGFB2")
# selected_genes <- c("TGFB2", "ATP2B4", "RANBP3L", "GOLGB1", "CD44", "GFAP", "CHI3L1")
# selected_genes <- c("SOD1")
selected_genes <- c(
  "GFAP", "CD44", "CHI3L1", "ATP2B4",
  "TGFB2", "RANBP3L", "GOLGB1", "MAOB"
)
# selected_genes <- c(
#   "UQCRB", "UQCRH", "NDUFC1", "NDUFA1", "ATP5F1A", "RPL36",
#   "RPS29", "HSPA1A", "GRIK4", "KCNN3", "RAP1GAP", "SEMA5B", "BDNF"
# )
...
to_plot_df <- df_genes_cpm %>%
  ...
  left_join(DE_used, by = c("gene" = "gene", "rna_anno_2ndRound_level_2" = "cell_type"))
...
# ggsave("./plots/DE_ALS_vs_Control_MCX_example_genes_Exc.pdf", device = cairo_pdf(), width = 4, height = 6, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_mFCX_example_genes_Exc.pdf", device = cairo_pdf(), width = 4, height = 6, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_MCX_example_genes_Exc_2.pdf", device = cairo_pdf(), width = 4, height = 6, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_mFCX_example_genes_Exc_2.pdf", device = cairo_pdf(), width = 4, height = 6, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_MCX_example_genes_Astro_3.pdf", device = cairo_pdf(), width = 4, height = 6, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_mFCX_example_genes_Astro_3.pdf", device = cairo_pdf(), width = 4, height = 6, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_MCX_SOD1.pdf", device = cairo_pdf(), width = 4, height = 3, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_mFCX_SOD1.pdf", device = cairo_pdf(), width = 4, height = 3, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_MCX_Exc.pdf", device = cairo_pdf(), width = 4, height = 3, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_MCX_Astro.pdf", device = cairo_pdf(), width = 4, height = 3, useDingbats = F)
...
# ggsave("./plots/DE_ALS_vs_Control_MCX_example_genes_Exc_2_split.pdf", device = cairo_pdf(), width = 4, height = 6, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_mFCX_example_genes_Exc_2_split.pdf", device = cairo_pdf(), width = 4, height = 6, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_MCX_example_genes_Astro_3_split.pdf", device = cairo_pdf(), width = 4, height = 6, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_mFCX_example_genes_Astro_3_split.pdf", device = cairo_pdf(), width = 4, height = 6, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_MCX_example_genes_Exc_split.pdf", device = cairo_pdf(), width = 4, height = 6, useDingbats = F)
# ggsave("./plots/DE_ALS_vs_Control_MCX_example_genes_Astro_split.pdf", device = cairo_pdf(), width = 4, height = 6, useDingbats = F)
ggsave("./plots/DE_ALS_vs_Control_mFCX_example_genes_Astro_split.pdf", device = cairo_pdf(), width = 4, height = 6, useDingbats = F)
