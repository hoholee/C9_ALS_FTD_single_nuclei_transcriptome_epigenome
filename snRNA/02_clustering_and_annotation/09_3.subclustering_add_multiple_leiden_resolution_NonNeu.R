...
data_obj_sub <- readRDS("./seurat_objects/snRNA_cellBender_corrected_dataset_SeuratV4_object_subset_NonNeu_scTransform_renormalized_annotated.rds")
...
leiden_resolution_list <- rev(c(0.05, 0.1, 0.3, 0.5, 0.8, 1.5, 1.8, 2, 2.5, 3, 3.5))
...
get_multiple_resolution_clusters <- function(selected_r){
	...
	write_tsv(res_meta, paste0("snRNA_subclustering_NonNeu_cellBender_corrected_leiden_clusters_res_", selected_r, ".txt"))
}
