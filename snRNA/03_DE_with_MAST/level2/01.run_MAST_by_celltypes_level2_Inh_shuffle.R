...
run_MAST <- function(selected_cluster, selected_region, selected_disease_1, selected_disease_2) {
  ...
  run_shuffle <- function(selected_seed) {
    ...
    saveRDS(zlmCond, paste0(
      "./zlm_rds_shuffle/MAST_zlmFit_level2_", selected_cluster, "_", selected_region, "_",
    ...
    saveRDS(summary_cond, paste0(
      "./zlm_rds_shuffle/MAST_zlmSummary_level_2_", selected_cluster, "_", selected_region, "_",
      selected_diseases[1], "_vs_", selected_diseases[2], "_seed_", selected_seed, ".rds"
    ))
  ...
  write_tsv(final_res, paste0(
    "./results_shuffle/MAST_res_level2_", selected_cluster, "_", selected_region, "_",
