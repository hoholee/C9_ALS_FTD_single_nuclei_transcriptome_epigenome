...
run_MAST <- function(selected_cluster, selected_region, selected_disease_1, selected_disease_2){
  ...
  saveRDS(zlmCond, paste0("./zlm_rds/MAST_zlmFit_level2_", selected_cluster, "_", selected_region, "_",
  ...
  toc()
  saveRDS(summary_cond, paste0("./zlm_rds/MAST_zlmSummary_level_2_", selected_cluster, "_", selected_region, "_",
                               selected_diseases[1], "_vs_", selected_diseases[2], ".rds"))
  ...
  write_tsv(final_res, paste0("./results/MAST_res_level2_", selected_cluster, "_", selected_region, "_",
...
param <- expand_grid(
  selected_cluster = c("Exc_superficial", "Exc_intermediate", "Exc_deep", "Exc_unknown"),
