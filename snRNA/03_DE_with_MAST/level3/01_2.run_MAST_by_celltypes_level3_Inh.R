...
param <- expand_grid(
  selected_cluster = c("Inh_SST_KLHL14", "Inh_SST_GPC5", "Inh_SST_EDNRA", "Inh_SST_CDH12",
		       "Inh_PVALB_CUX2", "Inh_PVALB_PIEZO2", "Inh_PVALB_MYBPC1", "Inh_PVALB_SCUBE3",
		       "Inh_LAMP5_CHST9", "Inh_LAMP5_CPLX3_Rosehip", "Inh_LAMP5_NDNF", "Inh_ADARB2_PAX6",
		       "Inh_ADARB2_SEMA3C", "Inh_ADARB2_LINC01470", "Inh_ADARB2_SCML4",
		       "Inh_VIP_ABI3BP", "Inh_VIP_CLSTN2", "Inh_VIP_FLT1", "Inh_VIP_ZBTB20", "Inh_VIP_DACH2"),
