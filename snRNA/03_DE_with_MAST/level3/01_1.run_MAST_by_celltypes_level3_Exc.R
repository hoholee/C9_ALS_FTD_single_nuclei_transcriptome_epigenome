...
run_MAST <- function(selected_cluster, selected_region, selected_disease_1, selected_disease_2){
  ...
  sub_idx <- which(meta_data$rna_anno_2ndRound_level_3 == selected_cluster &
  ...
  saveRDS(zlmCond, paste0("./zlm_rds/MAST_zlmFit_level3_", selected_cluster, "_", selected_region, "_",
  ...
  toc()
  saveRDS(summary_cond, paste0("./zlm_rds/MAST_zlmSummary_level_3_", selected_cluster, "_", selected_region, "_",
                               selected_diseases[1], "_vs_", selected_diseases[2], ".rds"))
  ...
  write_tsv(final_res, paste0("./results/MAST_res_level3_", selected_cluster, "_", selected_region, "_",
...
param <- expand_grid(
  selected_cluster = c("Exc_L2_IT_CUX2_PDGFD", "Exc_L2_IT_CUX2_CCBE1", "Exc_L2_IT_CUX2_LRRC2", "Exc_L2_IT_CUX2_SV2C",
		       "Exc_L2-3_IT_RORB_PRSS12", "Exc_L3_IT_RORB_OTOGL", "Exc_L3-5_IT_RORB_GABRG1", "Exc_L5_IT_RORB_NPFFR2",
		       "Exc_L3-5_IT_RORB_GRIN3A", "Exc_L3-5_IT_RORB_ADAMTSL1", "Exc_L3-5_IT_RORB_RPRM", "Exc_L6_IT_THEMIS_LINC00299",
		       "Exc_L6_IT_THEMIS_CFLAR", "Exc_L5-6_IT_THEMIS_SMYD1", "Exc_L5-6_NP_FOXP2_HTR2C", "Exc_L6b_TLE4_MDFIC",
		       "Exc_L6b_TLE4_KCNK2", "Exc_L6_CT_TLE4_SEMA5A", "Exc_L5_ET_FEZF2_ADRA1A", "Exc_TUBB2A"),
